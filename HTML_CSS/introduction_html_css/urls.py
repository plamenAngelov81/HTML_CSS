...
from HTML_CSS.introduction_html_css.views import Fruits, WikiPage, ToDoList, HtmlLists, DefinitionLists, \
    ReversedLists, ModernJS, BookStore, WorldCup, Welcome, HomePageIntroduction

urlpatterns = [
    path('introduction/', include([
        path('', HomePageIntroduction.as_view(), name='home page introduction'),
